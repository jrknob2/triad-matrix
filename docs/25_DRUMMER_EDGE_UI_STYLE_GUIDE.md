...
- Light/dark appearance and accent color are profile settings and must be
  persisted with app data. They apply immediately when changed; they are not
  staged behind a later Save action.
